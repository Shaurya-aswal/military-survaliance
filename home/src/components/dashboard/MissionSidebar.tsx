...
export function MissionSidebar() {
  ...
  return (
    <aside
      className={cn(
        'fixed left-0 top-0 z-40 flex h-screen flex-col border-r border-[hsl(217,33%,17%)]/60 bg-[hsl(222,47%,4%)] transition-all duration-300 ease-in-out',
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          {expanded && (
            <div className="min-w-0 animate-fade-in">
              <p className="text-xs font-bold text-slate-100 tracking-wider truncate">
                SENTINEL
              </p>
